<template>
    ...
    >
        ...
        <div v-else>
                 ...
                 <van-swipe-cell class="list-items" v-for="(item,index) in shopcartData" :key="index">
                    <div class="list-item clearfix">
                        ...
                        <div class="fl checkbox-item">
                            <van-checkbox v-model="item.isCheck" @change="simpleSelect" shape="round" />
                        </div>
                        <!-- 商品信息 -->
                            ...
                            <div class="fl product-content">
                                ...
                                <div class="product-text">
                                    <div class="clearfix product-name">
                                        ...
                                        <span class="product-rule fl">{{item.rule}}</span>
                                    </div>
            ...
            <!-- 提交订单 -->
            <div v-if="isManage">
                <van-submit-bar class="submit-bar" :price="total" :disabled="isNotHasCheck" button-text="提交订单" @submit="submitOrder">
                    <van-checkbox v-model="allCheck" @click="allSelect">全选</van-checkbox>
                </van-submit-bar>
            </div>
            <div v-else>
                <van-submit-bar class="submit-bar submit-bar-delete"  :disabled="isNotHasCheck" button-text="删除订单" @submit="removeMoreShopcart">
                    <van-checkbox v-model="allCheck" @click="allSelect">全选</van-checkbox>
                </van-submit-bar>
            </div>
