<template>
    <div class="order">
        <van-nav-bar title="提交订单" left-text="返回"  @click-left="goback"/>
                    ...
                    <div class="order-item">
                        ...
                        <div class="order-total clearfix">
                            <div class="fr clearfix">
                                <span class="fl total-count">共计  {{counts}} 件商品 合集：</span>
            ...
            <van-submit-bar :price="total * 100 " class="pay" button-text="立即结算"  @submit="commit"/>

            <van-popup v-model="isOpen" position="bottom" class="popup-box" >
                 <van-address-list v-model="aid" :list="addressList" default-tag-text="默认" @add="addAddress" @select="selectAddress" />
            </van-popup>
    </div>
</template>
